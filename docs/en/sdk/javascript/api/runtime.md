...
`DegradeProfile`, `RouteHint`, `ExecutionHint`, `TraceContext`, `ResultDropReason`,
`ObjectDeclare`, `ObjectRef`, `ObjectRelease`, `ObjectPatch`, `ObjectDelta`, `CacheReference`,
`CacheMiss`, `ErrorRecoverable`, `RetryAfter`.
